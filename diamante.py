...
def carregar_sprites_diamantes() :
    ...
    DIAMANTE_VERMELHO_SPRITE = pygame.image.load("foguinho-e-agua-IP\Imagens\diamante_vermelho.png").convert_alpha()
    DIAMANTE_AZUL_SPRITE = pygame.image.load("foguinho-e-agua-IP\Imagens\diamante_azul.png").convert_alpha()

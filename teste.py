...
class Jogo:
    def __init__(self):
        ...
        # NOVO: Inicialização de todos os contadores e bandeiras de rastreamento
        ...
        # NOVO: Contador de diamantes dinâmico
    ...
    def atualizar(self):
        ...
        # RESTAURADO: Lógica original ("remendo") para mover o jogador com a plataforma
        for jogador in [self.jogador1, self.jogador2]:
        ...
        # NOVO: Contagem de ativações ÚNICAS para botões
        ...
        # NOVO: Contagem de ativações ÚNICAS para alavancas
        for alavanca in self.alavancas:
            # Assumindo que a classe Alavanca tem um atributo .ativada
    ...
    def desenhar(self):
        ...
        if self.estado == MENU:
            ...
            # NOVO: Exibição de todos os contadores no canto superior direito
